...
public class SerialTool {
    ...
    public static void setOnReceiveListen(SerialPort serialPort, SerialReceiveCall call) throws ReadDataFromSerialPortFailure, SerialPortInputStreamCloseFailure {
        while (true) {
            if (serialPort != null)
                call.onReceive(new String(readFromPort(serialPort)));
            else return;
        }
    }
