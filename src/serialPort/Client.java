...
public class Client extends Frame{
	...
	//持有其他类
	DataView2 dataview = new DataView2(this);	//主界面类（显示监控数据主面板）
	...
	public void paint(Graphics g) {
		...
		g.drawString("欢迎使用手环泳标读取系统", 45, 190);
		
		g.setFont(new Font("微软雅黑", Font.ITALIC, 26));
		g.setColor(Color.BLACK);
		g.drawString("ThreeTun Version：1.0   Powered By：JinLiang", 180, 260);
